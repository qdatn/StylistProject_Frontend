...
const IMAGE = "../src/public/assets/images/default-product-image.png"
  ...
  return (
    <>
      <div className={`containermax-w-7xl mx-auto p-8 bg-white `}>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative z-10 px-10 py-8 text-center max-w-md w-full">
              <p className="text-white mb-6">
                We're sorry, this item is not available right now.
              </p>
              <button
        ...
        <div className={`${product.status === false ? 'pointer-events-none opacity-80' : ''}`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
            ...
            <div className="flex justify-center lg:px-28 px-0">
              <div className="relative w-[600px] h-[400px] flex items-center justify-center">
                ...
                >
                  <img
                    src={product.images?.length ? product.images[currentImageIndex] : IMAGE}
