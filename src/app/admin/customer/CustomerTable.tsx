...
import { Customer, OrderList, OrderListAdmin, OrderTracking } from '@src/types/Customer'; // Import type của Customer
...
const orderColumns: ColumnsType<Customer> = [
    {
        title: 'ID',
        dataIndex: '_id',
    },
...
const CustomerTable: React.FC<OrderTableProps> = ({
    orders,
    onDeleteSuccess,
    onPageChange,
    pagination
